 ...
 *
 * CostTrendChart.test.tsx: cover rendering against a 4-week and an 8-week window.
 */
import type { TrendSlotProps } from './campaignTypes';

export default function CostTrendChart(_props: TrendSlotProps) {
  return (
    <div className="empty flex h-full flex-col items-center justify-center gap-1 text-center">
      <h2 className="heading-lg">Cost Trend</h2>
      <p className="body-sm">
