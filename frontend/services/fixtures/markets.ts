...
export const MOCK_MARKETS: Market[] = [
  {
    id: 'korea', rank: 1, name: 'South Korea', city: 'Seoul', matchScore: 87,
    ...
    accessibilityScore: 10, flightFrequency: 14,
    fareMinPhp: 8000, fareMaxPhp: 15000, fareSource: 'static_reference_v1', fareAsOf: '2026-09-11',
    airlines: [
    ...
    surgeLevel: 'CRITICAL', upliftPct: 28.4, windowOpenDate: '2026-09-07T00:00:00Z', scorer: 'linear',
    gdpSource: 'live', forexSource: 'live', macroAsOf: '2026-08-30T00:00:00Z',
    forecastConfidence: 0.87, lowConfidence: false, forecastSource: 'stub-v1',
    dataAsOf: '2026-08-30T00:00:00Z', dataStale: false, dataStaleCause: null,
    ...
    chartData: buildChartData({ base: 52, amp: 9, drift: 1.6, seasonBase: 64, seasonPhase: 0, spikeAt: 11, weekly: [76.4, 74.9, 73.1, 71.5, 70.2, 69.4, 68.7, 68.1, 67.6, 67.2, 66.8, 66.5] }),
  },
  {
    id: 'japan', rank: 2, name: 'Japan', city: 'Osaka', matchScore: 79,
    ...
    accessibilityScore: 9, flightFrequency: 8,
    fareMinPhp: 8000, fareMaxPhp: 15000, fareSource: 'static_reference_v1', fareAsOf: '2026-09-11',
    airlines: [
    ...
    surgeLevel: 'WARNING', upliftPct: 22.1, windowOpenDate: '2026-09-14T00:00:00Z', scorer: 'linear',
    gdpSource: 'live', forexSource: 'live', macroAsOf: '2026-08-30T00:00:00Z',
    forecastConfidence: 0.91, lowConfidence: false, forecastSource: 'stub-v1',
    dataAsOf: '2026-08-30T00:00:00Z', dataStale: false, dataStaleCause: null,
    ...
    chartData: buildChartData({ base: 44, amp: 7, drift: 1.3, seasonBase: 58, seasonPhase: 2, spikeAt: null, weekly: [63.8, 65.2, 66.9, 68.4, 69.1, 69.8, 70.3, 70.1, 69.7, 69.2, 68.8, 68.3] }),
  },
  {
    id: 'usa', rank: 3, name: 'United States', city: 'Los Angeles', matchScore: 64,
    ...
    accessibilityScore: 4, flightFrequency: 3,
    fareMinPhp: 25000, fareMaxPhp: 40000, fareSource: 'static_reference_v1', fareAsOf: '2026-09-11',
    ...
    surgeLevel: null, upliftPct: null, windowOpenDate: null, scorer: 'linear',
    gdpSource: 'live', forexSource: 'live', macroAsOf: '2026-08-30T00:00:00Z',
    forecastConfidence: 0.68, lowConfidence: true, forecastSource: 'stub-v1',
    dataAsOf: '2026-08-30T00:00:00Z', dataStale: false, dataStaleCause: null,
    ...
    chartData: buildChartData({ base: 38, amp: 6, drift: 1.5, seasonBase: 52, seasonPhase: 4, spikeAt: null, weekly: [57.2, 58.9, 60.4, 62.1, 63.6, 64.8, 65.9, 66.7, 67.2, 67.5, 67.1, 66.6] }),
  },
];
