...
export const MOCK_MARKETS: Market[] = [
  ...
  },
  {
    ...
    directive: 'US demand just spiked — the 2σ threshold broke and last year shows the same calendar-window pattern, so this is a confirmed seasonal surge, not a blip. Accessibility remains the constraint: no direct route and 16h+ via Manila. Lead with experiences that justify the flight — freediving, the sardine run, heritage. Americans book 6–10 weeks out, so the window is now.',
    ...
    seasonalityScore: 0.79, yoyRatio: 1.18, spikeIndicator: true,
    dataAsOf: '2026-08-30T00:00:00Z', dataStale: false,
    ...
    seasonalityInsight: 'A confirmed spike is now visible (YoY 1.18, seasonality 0.79) — US demand has broken sharply above baseline heading into the June–August summer window, matching last year\'s calendar pattern closely enough to call it seasonal rather than a one-off. Long-haul planners already book 6–10 weeks out, so the response window is short.',
    ...
    chartData: buildChartData({ base: 38, amp: 6, drift: 1.5, seasonBase: 52, seasonPhase: 4, forex: 57.6, forexAmp: 0.5, gdp: 2.5, spikeAt: 11, weekly: [57.2, 58.9, 60.4, 62.1, 63.6, 64.8, 65.9, 66.7, 67.2, 67.5, 67.1, 66.6] }),
  },
];
