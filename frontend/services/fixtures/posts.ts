...
export const MOCK_POSTS: PublishedPost[] = [
  { id: 'p1', date: '2026-08-04', platform: 'instagram', caption: 'POV: you booked the 호캉스 you kept postponing 🌴 Sunset Cove, Moalboal — sardine run at sunrise, hammock by noon.', status: 'published', reach: 31200, likes: 2810, comments: 142, shares: 890, engagementRate: 12.3, series: [8, 14, 22, 29, 31, 30, 28] },
  ...
  { id: 'p4', date: '2026-07-28', platform: 'instagram', caption: 'The water goes quiet first. Then the light shifts, and a wall of silver turns beneath you.', status: 'published', reach: 18600, likes: 1180, comments: 64, shares: 301, engagementRate: 8.3, series: [5, 9, 13, 16, 18, 18, 17] },
