"""
Deterministic mock outputs for Module 2 forecasting and market data models
that aren't trained yet.  Keyed by a hash of the input so the frontend
sees stable values across reloads.
"""
