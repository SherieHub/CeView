-- V18 — Module 2 (market signals/forecasting) and Module 3 (promotional content/
...
--
-- ── Operator -> target_market map (chosen plausibly per business/category) ────
--   1. Moalboal FreeDive Cebu               (Coastal & Island)          -> korea
--   2. Oslob Whale Shark Adventures         (Adventure & Nature)        -> usa
--   3. Bantayan Blue Waters Island Hopping  (Coastal & Island)          -> japan
--   4. Sugbo Heritage Walks                 (Cultural & Heritage)       -> japan
--   5. Sinulog Fiesta Dance & Cultural Show (Theme Parks / Entertainment)-> usa
--   6. Nena's Talisay Lechon House          (Culinary & Gastronomy)     -> korea
--   7. Mactan Sunset Beachfront Resort      (Accommodation & Staycation)-> korea
--   8. IT Park Nightlife & City Tour Co.    (Urban & City)              -> usa
--   9. Carbon Market Street Food Crawl      (Culinary & Gastronomy)     -> japan
--
-- ── Fixed UUID scheme (N = operator index 1..9, matches V2's business_profile_id) ─
...
--   80000000-...-00000000000N : tbl_demand_alert (only operators 1, 3, 5, 7, 9 —
--                                the ones with a notable spike this cycle)
--   90000000-...-000000000001/2/3 : tbl_market_economic_trend (korea/japan/usa;
--                                shared/global rows, not per-operator)
...
-- and the compliance tables (dropped in V16 — do not reference).
...
INSERT INTO tbl_market_signal_record (
    ...
    ('51000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'korea', 58, 0.0413, 2.1, 0.62, 55, FALSE, 4.2, 55, 50, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'korea', 76, 0.0416, 2.1, 0.62, 61, TRUE,  7.8, 61, 52, NULL, '2026-07-27 09:00:00+08'),
    -- Op 2 — Oslob Whale Shark Adventures (usa)
    ('51000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'usa', 61, 58.42, 2.6, 0.55, 60, FALSE, 3.1, 60, 58, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'usa', 64, 58.65, 2.6, 0.55, 62, FALSE, 3.4, 62, 59, NULL, '2026-07-27 09:00:00+08'),
    -- Op 3 — Bantayan Blue Waters Island Hopping (japan)
    ('51000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'japan', 45, 0.384, 0.9, 0.70, 44, FALSE, 3.8, 44, 41, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'japan', 63, 0.387, 0.9, 0.70, 50, TRUE,  6.9, 50, 43, NULL, '2026-07-27 09:00:00+08'),
    -- Op 4 — Sugbo Heritage Walks (japan)
    ('51000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'japan', 39, 0.384, 0.9, 0.40, 38, FALSE, 2.0, 38, 37, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'japan', 41, 0.387, 0.9, 0.40, 40, FALSE, 2.2, 40, 38, NULL, '2026-07-27 09:00:00+08'),
    -- Op 5 — Sinulog Fiesta Dance & Cultural Show (usa)
    ('51000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000005', 'usa', 50, 58.42, 2.6, 0.45, 49, FALSE, 3.5, 49, 46, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000005', 'usa', 70, 58.65, 2.6, 0.45, 56, TRUE,  7.1, 56, 48, NULL, '2026-07-27 09:00:00+08'),
    -- Op 6 — Nena's Talisay Lechon House (korea)
    ('51000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000006', 'korea', 55, 0.0413, 2.1, 0.58, 54, FALSE, 2.6, 54, 52, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000006', 'korea', 57, 0.0416, 2.1, 0.58, 56, FALSE, 2.8, 56, 53, NULL, '2026-07-27 09:00:00+08'),
    -- Op 7 — Mactan Sunset Beachfront Resort (korea)
    ('51000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000007', 'korea', 60, 0.0413, 2.1, 0.68, 58, FALSE, 4.0, 58, 55, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000007', 'korea', 79, 0.0416, 2.1, 0.68, 64, TRUE,  8.2, 64, 57, NULL, '2026-07-27 09:00:00+08'),
    -- Op 8 — IT Park Nightlife & City Tour Co. (usa)
    ('51000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000008', 'usa', 48, 58.42, 2.6, 0.42, 47, FALSE, 2.2, 47, 46, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000008', 'usa', 50, 58.65, 2.6, 0.42, 49, FALSE, 2.4, 49, 47, NULL, '2026-07-27 09:00:00+08'),
    -- Op 9 — Carbon Market Street Food Crawl (japan)
    ('51000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000009', 'japan', 42, 0.384, 0.9, 0.50, 41, FALSE, 3.3, 41, 39, NULL, '2026-07-20 09:00:00+08'),
    ('50000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000009', 'japan', 68, 0.387, 0.9, 0.50, 48, TRUE,  7.6, 48, 41, NULL, '2026-07-27 09:00:00+08')
...
INSERT INTO tbl_forecast_result (
    ...
    ('60000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'korea', 79.4, 0.84, 8.2,  3.1, 4.0, 4, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'usa',   66.8, 0.81, 9.6,  3.6, 4.5, 8, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'japan', 66.2, 0.78, 10.4, 4.0, 5.1, 4, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'japan', 42.5, 0.87, 6.9,  2.2, 2.9, 8, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000005', 'usa',   73.1, 0.76, 11.8, 4.4, 5.6, 4, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000006', 'korea', 59.0, 0.85, 7.4,  2.5, 3.2, 8, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000007', 'korea', 82.6, 0.79, 10.9, 4.6, 5.9, 4, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000008', 'usa',   51.7, 0.83, 8.0,  2.4, 3.0, 8, '2026-07-27 10:00:00+08'),
    ('60000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000009', 'japan', 70.9, 0.77, 12.1, 4.3, 5.4, 4, '2026-07-27 10:00:00+08')
ON CONFLICT (forecast_result_id) DO NOTHING;
...
INSERT INTO tbl_market_score (
    ...
    ('70000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', 0.81, 0.62, TRUE,  2.1, 0.0416, 128000, 1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000002', 0.74, 0.55, FALSE, 2.6, 58.65,  96000,  1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000003', '60000000-0000-0000-0000-000000000003', 0.77, 0.70, TRUE,  0.9, 0.387,  41000,  1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000004', '60000000-0000-0000-0000-000000000004', 0.68, 0.40, FALSE, 0.9, 0.387,  35000,  1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000005', '60000000-0000-0000-0000-000000000005', 0.71, 0.45, TRUE,  2.6, 58.65,  88000,  1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000006', '60000000-0000-0000-0000-000000000006', 0.79, 0.58, FALSE, 2.1, 0.0416, 132000, 1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000007', '60000000-0000-0000-0000-000000000007', 0.83, 0.68, TRUE,  2.1, 0.0416, 121000, 1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000008', '60000000-0000-0000-0000-000000000008', 0.66, 0.42, FALSE, 2.6, 58.65,  79000,  1, '2026-07-27 10:05:00+08'),
    ('70000000-0000-0000-0000-000000000009', '60000000-0000-0000-0000-000000000009', 0.75, 0.50, TRUE,  0.9, 0.387,  38000,  1, '2026-07-27 10:05:00+08')
ON CONFLICT (market_score_id) DO NOTHING;
...
INSERT INTO tbl_demand_alert (
    ...
    ('80000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 'WARNING',
     ...
     FALSE, 'Rising demand window', '2026-08-03 10:10:00+08', '2026-07-27 10:10:00+08'),
    ('80000000-0000-0000-0000-000000000003', '70000000-0000-0000-0000-000000000003', 'WARNING',
     ...
     TRUE, 'Rising demand window', '2026-08-03 10:10:00+08', '2026-07-27 10:10:00+08'),
    ('80000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000005', 'CRITICAL',
     ...
     FALSE, 'Sudden interest spike', '2026-08-03 10:10:00+08', '2026-07-27 10:10:00+08'),
    ('80000000-0000-0000-0000-000000000007', '70000000-0000-0000-0000-000000000007', 'CRITICAL',
     ...
     TRUE, 'Sudden interest spike', '2026-08-03 10:10:00+08', '2026-07-27 10:10:00+08'),
    ('80000000-0000-0000-0000-000000000009', '70000000-0000-0000-0000-000000000009', 'WARNING',
     ...
     FALSE, 'Rising demand window', '2026-08-03 10:10:00+08', '2026-07-27 10:10:00+08')
ON CONFLICT (demand_alert_id) DO NOTHING;

-- ── tbl_market_economic_trend: 3 global/shared rows (one per market) ─────────
INSERT INTO tbl_market_economic_trend (
    ...
    ('90000000-0000-0000-0000-000000000001', 'korea',
     ...
     2.1, 0.0416, 'KRW', 5, 4, '2026-07-27 08:00:00+08'),
    ('90000000-0000-0000-0000-000000000002', 'japan',
     ...
     0.9, 0.387, 'JPY', 5, 4, '2026-07-27 08:00:00+08'),
    ('90000000-0000-0000-0000-000000000003', 'usa',
     ...
     2.6, 58.65, 'USD', 5, 4, '2026-07-27 08:00:00+08')
...
INSERT INTO tbl_localized_promotional_content (
    ...
    ('a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'korea', 'Instagram',
     ...
     'AIDA', 'gemini', TRUE, '2026-07-29 09:15:00+08', '2026-07-28 09:00:00+08'),
    ...
    ('a0000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'usa', 'Facebook',
     ...
     'PAS', 'gemini', FALSE, NULL, '2026-07-28 09:00:00+08'),
...
INSERT INTO tbl_creative_direction_output (
    ...
    ('b0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'korea',
     ...
     'Crisp, adventurous, trust-building', TRUE, '2026-07-29 09:15:00+08', '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'usa',
     ...
     'Awe-driven, respectful, documentary-style', FALSE, NULL, '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'japan',
     ...
     'Serene, uncrowded, intimate', TRUE, '2026-07-29 09:15:00+08', '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'japan',
     ...
     'Scholarly, respectful, immersive', FALSE, NULL, '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000005', 'usa',
     ...
     'High-energy, festive, celebratory', TRUE, '2026-07-29 09:15:00+08', '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000006', 'korea',
     ...
     'Warm, indulgent, heritage-proud', FALSE, NULL, '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000007', 'korea',
     ...
     'Luxurious, relaxing, aspirational', TRUE, '2026-07-29 09:15:00+08', '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000008', 'usa',
     ...
     'Social, upbeat, insider-access', FALSE, NULL, '2026-07-28 09:30:00+08'),
    ...
    ('b0000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000009', 'japan',
     ...
     'Authentic, curious, community-rooted', TRUE, '2026-07-29 09:15:00+08', '2026-07-28 09:30:00+08')
ON CONFLICT (creative_direction_id) DO NOTHING;
...
INSERT INTO tbl_promotional_asset (
    ...
    ('c0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'video', '/assets/promo/op1-moalboal-freedive-sardine-run.mp4', 'processed', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'image', '/assets/promo/op2-oslob-whaleshark-sunrise.jpg', 'uploaded', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'video', '/assets/promo/op3-bantayan-sandbar-hopping.mp4', 'processed', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'image', '/assets/promo/op4-sugbo-heritage-fortsanpedro.jpg', 'uploaded', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000005', 'video', '/assets/promo/op5-sinulog-dance-show.mp4', 'processed', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000006', 'image', '/assets/promo/op6-nena-lechon-charcoal.jpg', 'uploaded', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000007', 'video', '/assets/promo/op7-mactan-sunset-resort-cove.mp4', 'processed', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000008', 'image', '/assets/promo/op8-itpark-rooftop-nightlife.jpg', 'uploaded', '2026-07-28 09:30:00+08'),
    ('c0000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000009', 'video', '/assets/promo/op9-carbon-market-streetfood.mp4', 'processed', '2026-07-28 09:30:00+08')
