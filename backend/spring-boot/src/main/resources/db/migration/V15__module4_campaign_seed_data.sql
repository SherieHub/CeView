-- V15 — Module 4: Campaign Seed Data (9 per-operator campaign histories)
-- ─────────────────────────────────────────────────────────────────────────────
...
--   ROAS=2.67  CTR=1.78  CR=3.44  CAC=300.0  CPC=3.75  PES≈0.4027 (Fair Performance, cold start)
    ('20000000-0000-0000-0000-000000000001',
     ...
     '2026-03-02 09:00:00+08', '2026-03-02 09:45:00+08'),
...
--   ROAS=5.55  CTR=2.98  CR=6.05  CAC=145.33  CPC=2.87  PES≈0.6 (Good Performance)
    ('20000000-0000-0000-0000-000000000005',
     ...
     '2026-05-18 09:00:00+08', '2026-05-18 09:45:00+08');
...
--   ROAS=2.42  CTR=2.18  CR=3.58  CAC=292.31  CPC=3.17  PES≈0.4 (Fair Performance)
    ('20000000-0000-0000-0000-000000000007',
     ...
     '2026-05-25 09:00:00+08', '2026-05-25 09:45:00+08'),
...
--   ROAS=1.87  CTR=1.9  CR=3.26  CAC=416.67  CPC=3.95  PES≈0.36 (Poor Performance)
    ('20000000-0000-0000-0000-000000000007',
     ...
     '2026-06-01 09:00:00+08', '2026-06-01 09:45:00+08'),
...
--   ROAS=1.43  CTR=1.65  CR=2.89  CAC=528.57  CPC=4.87  PES≈0.33 (Poor Performance)
    ('20000000-0000-0000-0000-000000000007',
     ...
     '2026-06-08 09:00:00+08', '2026-06-08 09:45:00+08');
