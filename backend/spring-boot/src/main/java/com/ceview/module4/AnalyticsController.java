...
public class AnalyticsController {
    ...
    public ManualIngestResponse manualIngest(@RequestBody ManualIngestRequest in) {
        ...
        try {
            ...
            pes = buildPesResponse(pesResult, mr.metrics());
    ...
    /**
     * Reconstruct a typed PesResponse from the FastAPI result map.
     * Falls back to rule-based computation if the map is missing required keys.
     */
    @SuppressWarnings("unchecked")
    private PesResponse buildPesResponse(Map<String, Object> pesResult, Metrics metrics) {
        try {
