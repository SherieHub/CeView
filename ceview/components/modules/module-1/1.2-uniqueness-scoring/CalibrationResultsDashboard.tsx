...
import OverallScoreCard from '../../../composites/module-1/1.2-uniqueness-scoring/OverallScoreCard';
import ActionableScoreCard from '../../../composites/module-1/1.2-uniqueness-scoring/ActionableScoreCard';
...
const CalibrationResultsDashboard: React.FC<DashboardProps> = ({ isAwaiting, result, onConfirm }) => {
  ...
  return (
    <div className="h-full flex flex-col animate-fade-in">
      ...
      {/* ✨ UPDATED: 3 Boards in a horizontal row */}
