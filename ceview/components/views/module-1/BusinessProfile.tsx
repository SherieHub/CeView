  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-8 animate-fade-in" style={{ backgroundColor: COLORS.CREAM, minHeight: '100vh' }}>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
           <h1 className="text-3xl font-black tracking-tight leading-none" style={{ color: COLORS.NAVY }}>Executive Profile</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
           ...
           <div className="p-6 md:p-8">
              <div className="flex items-end gap-4 -mt-16 mb-8 relative z-10">
                 <div className="w-24 h-24 bg-white rounded-2xl shadow-lg border border-slate-100 flex items-center justify-center shrink-0">
                     <User size={40} style={{ color: COLORS.NAVY }} />
                 </div>
                 <div className="pb-2">
                     <h2 className="text-2xl font-black leading-tight" style={{ color: COLORS.NAVY }}>{businessName || 'Unnamed Entity'}</h2>
        ...
        {/* ══ RIGHT: OPERATIONS & SOCIAL (1/3 Width) ══ */}
