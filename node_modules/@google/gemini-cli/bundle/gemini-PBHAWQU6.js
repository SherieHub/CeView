...
import {
  startCommand,
  startServer
} from "./chunk-2PZUIVU3.js";
import {
  exitCli,
  require_source
} from "./chunk-UH3BLMAQ.js";
import {
  DEFAULT_PORT,
  GEMMA_MODEL_NAME,
  ...
  resolveGemmaConfig,
  saveModelChange
} from "./chunk-ORAERZ7C.js";
import {
  RELAUNCH_EXIT_CODE
} from "./chunk-6PXLKFEE.js";
import "./chunk-KZP4B2KY.js";
import {
  cleanupCheckpoints,
  registerCleanup,
  registerSyncCleanup,
...
async function runNonInteractive({
  ...
  return promptIdContext.run(prompt_id, async () => {
    ...
    if (process.env["GEMINI_CLI_ACTIVITY_LOG_TARGET"]) {
      const { setupInitialActivityLogger } = await import("./devtoolsService-OFCX6SOA.js");
...
async function startInteractiveUI(config, settings, startupWarnings, workspaceRoot = process.cwd(), resumedSessionData, initializationResult) {
  const { startInteractiveUI: doStartUI } = await import("./interactiveCli-2RXDSQZ7.js");
  await doStartUI(
    config,
    settings,
    startupWarnings,
...
${finalArgs[promptIndex + 1]}`;
  ...
  }
  {
    ...
    initAppHandle?.end();
    import("./liteRtServerManager-ZU6GBYTQ.js").then(({ LiteRtServerManager }) => {
