...
| Layer             | Component             | File                                                                                                               | Responsibility                                                                                                                                                                                                                                                                    |
| ----------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Router**        | `forecastingRouter`   | `app/routers/forecasting.py`                                                                                       | `POST /inference-batch` — receives all 3 market sequences, returns 12 weekly forecasts per market in one Groq `llama-3.3-70b-versatile` call; `POST /score` — XGBoost economic scoring per market                                                                                 |
| **Service**       | `gemini_forecaster`   | `app/services/gemini_forecaster.py`                                                                                | `forecast_batch()` bundles all 3 prompts into 1 **Groq `llama-3.3-70b-versatile`** API call (OpenAI-compatible client); applies flat-line + ceiling/floor guards; `_stub_forecast()` fallback via linear regression. File named `gemini_forecaster.py` — Phase 2 naming artifact. |
